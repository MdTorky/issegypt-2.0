    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="lg:w-120 w-100 p-4 rounded-lg border-[1px] border-slate-300 dark:border-gray-700 relative overflow-hidden group bg-whitetheme dark:bg-darktheme2 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
