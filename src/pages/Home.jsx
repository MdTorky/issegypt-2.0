...
const Home = ({ languageText, language, api }) => {
    ...
    const [slides, setSlides] = useState([
        ...
        { id: 2, imgSrc: "https://res.cloudinary.com/dmv4mxgn5/image/upload/v1733707989/Home%20Page/Group_Photo_2_sdwxxe.jpg", title: "Welcome Day", aTitle: "يوم الترحيب", description: "Where ISS Egypt Welcomes New Students and gives them a hand in their upcoming years", aDescription: "حيث رحب الاتحاد المصري بالطلاب الجدد وقدم لهم المساعدة في سنواتهم القادمة" },
        ...
        { id: 4, imgSrc: "https://res.cloudinary.com/dmv4mxgn5/image/upload/v1740087793/Home%20Page/El7aref_vllvh6.jpg", title: "El7aref Tournament", aTitle: "بطولة الحريف", description: "A Futsal Tournament that ISS Egypt organized", aDescription: "بطولة كرة الفوتسال التي نظمها الاتحاد المصري" }
    ]);
